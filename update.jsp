			...
			<div class="row justify-content-center align-items-center h-100">
				<div>
					...
					<div class="card-body p-4 p-md-5 ">
						...
						<form id="registerCustomer" modelAttribute="edit"
								...
								<div class="col-md-3 mb-4">
									...
									<div class="form-outline">
										<label class="form-label" for="fname"
											...
											name="id" class="form-control form-control-lg" value="${cust.getId()}"readonly
								...
								<div class="col-md-3 mb-4">
									...
									<div class="form-outline">
										<label class="form-label" for="fname"
											...
											name="fname" class="form-control form-control-lg" value="${cust.getFname()}"
								...
								<div class="col-md-3 mb-4">
									...
									<div class="form-outline">
										<label class="form-label" for="lname"
											...
											name="lname" class="form-control form-control-lg" value="${cust.getLname()}"
								...
								<div class="col-md-3 mb-4 d-flex align-items-center">
									...
									<div class="form-outline datepicker w-100">
										<label for="birthdayDate" class="form-label"
											...
											style="color: red;"> *</span></label> <input type="date" name="dob" value="${cust.getDob()}"
									...
									<div class="col-md-4 ">
										...
										<div class="form-outline">
											<label class="form-label" for="phonenumber"
												...
												id="phonenumber" class="form-control form-control-lg" value="${cust.getMobileno()}"
								...
								<div>
									<div class="form-outline">
										<label class="form-label" for="address"
											...
											name="address" class="form-control form-control-lg" value="${cust.getAddress()}"
									...
									<div class="col-md-6 mb-4"
										...
										<div class="form-outline">
											<label class="form-label" for="username"
												...
												id="username" class="form-control form-control-lg" value="${cust.getUsername()}"
									...
									<div class="col-md-6 mb-4"
										...
										<div class="form-outline">
											<label class="form-label" for="password"
												...
												style="color: red;"> *</span></label> <input type="text"
												id="password" class="form-control form-control-lg" value="${cust.getPassword()}"
